...
/**
 * @classname: SysDictDetailServiceHystrix
 * @description: 定义  sys_dict_detail,微服务断路器
...
@Component
@Log
public class  SysDictDetailServiceHystrix implements  SysDictDetailServicefeign{

		@Override
		public ResponseResult<Object> querySysDictDetailByPrimaryKey(String message) {
		...
		@Override
		public ResponseResult<String> insertSysDictDetail(@RequestBody SysDictDetailDTO obj) {
			return GetResponseResult.result();

		}

		@Override
		public ResponseResult<String> updateSysDictDetail(@RequestBody SysDictDetailDTO obj) {
			return GetResponseResult.result();

		}

		@Override
		public ResponseResult<Object> searchCodeSysDictDetail(String code) {
			return GetResponseResult.result();
		}
