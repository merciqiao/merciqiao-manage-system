...
/**
 * @classname: SysDictServiceHystrix
 * @description: 定义  sys_dict,微服务断路器
...
@Component
@Log
public class  SysDictServiceHystrix implements  SysDictServicefeign{

		@Override
		public ResponseResult<Object> querySysDictByPrimaryKey(String message) {
		...
		@Override
		public ResponseResult<String> insertSysDict(@RequestBody SysDictDTO obj) {
			return GetResponseResult.result();

		}

		@Override
		public ResponseResult<String> updateSysDict(@RequestBody SysDictDTO obj) {
			return GetResponseResult.result();

		}

	@Override
	public ResponseResult count(String dictCode) {
		return null;
	}
