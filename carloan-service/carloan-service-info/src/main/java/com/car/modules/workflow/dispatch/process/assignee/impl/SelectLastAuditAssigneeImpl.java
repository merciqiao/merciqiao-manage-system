 ...
 */
@Service(value = "com.car.modules.workflow.dispatch.process.assignee.impl.SelectLastAuditAssigneeImpl")
public class SelectLastAuditAssigneeImpl extends AbstractSelectAssignee {
    @Autowired
    ...
    protected String getAssigneeByRuleInternal(ConfVO confVO) {
        String userId;
        confVO.setRuleCode(RuleCodeConstant.LAST_AUDIT_RULE);
