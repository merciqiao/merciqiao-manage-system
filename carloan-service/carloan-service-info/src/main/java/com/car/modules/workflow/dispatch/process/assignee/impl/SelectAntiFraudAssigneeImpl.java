 ...
 */
@Service(value = "com.car.modules.workflow.dispatch.process.assignee.impl.SelectAntiFraudAssigneeImpl")
public class SelectAntiFraudAssigneeImpl extends AbstractSelectAssignee {
    @Autowired
    ...
    protected String getAssigneeByRuleInternal(ConfVO confVO) {
        String userId;
        confVO.setRuleCode(RuleCodeConstant.ANTI_FRAUD_RULE);
