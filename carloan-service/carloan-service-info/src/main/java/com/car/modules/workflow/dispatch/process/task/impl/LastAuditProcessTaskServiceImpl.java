 ...
 */
@Component
public class LastAuditProcessTaskServiceImpl extends AbstractProcessTask {
    @Autowired
    @Qualifier("com.car.modules.workflow.dispatch.process.assignee.impl.SelectLastAuditAssigneeImpl")
    private ISelectAssignee selectAssignee;
    @Override
    public String getType() {
        StringBuilder builder = new StringBuilder();
        builder.append(CarFlowConst.CAR_TASKTYPE_XINSHEN).append(":").append(CarFlowConst.LAST_AUDIT);
