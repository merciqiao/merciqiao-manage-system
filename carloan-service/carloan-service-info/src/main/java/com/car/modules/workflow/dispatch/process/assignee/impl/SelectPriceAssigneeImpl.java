 ...
 */
@Service(value = "com.car.modules.workflow.dispatch.process.assignee.impl.SelectPriceAssignee")
public class SelectPriceAssigneeImpl extends AbstractSelectAssignee {
    @Autowired
    ...
    protected String getAssigneeByRuleInternal(ConfVO confVO) {
        String userId;
        confVO.setRuleCode(RuleCodeConstant.PRICE_RULE);
