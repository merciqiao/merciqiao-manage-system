 ...
 */
@Service(value = "com.car.modules.workflow.dispatch.process.assignee.impl.SelectAuditAssigneeImpl")
public class SelectAuditAssigneeImpl extends AbstractSelectAssignee {
    @Autowired
    ...
    protected String getAssigneeByRuleInternal(ConfVO confVO) {
        String userId;
        confVO.setRuleCode(RuleCodeConstant.AUDIT_RULE);
