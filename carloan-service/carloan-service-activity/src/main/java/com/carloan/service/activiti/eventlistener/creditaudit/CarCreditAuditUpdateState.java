package com.carloan.service.activiti.eventlistener.creditaudit;
...
@Component
@Slf4j
public class CarCreditAuditUpdateState implements ExecutionListener {
    @Autowired
    ...
    public void notify(DelegateExecution delegateExecution) throws Exception {
        ...
        Response result= workFlowFeign.updateOrderState_XinShen(taskEventParam);
        String msg=MessageFormat.format("CarCreditAuditUpdateState.notify.{0},taskEventParam:{1}", result,taskEventParam.toString());
