...
package com.carloan.service.shiro.sysmenu.service;
...
import com.carloan.service.shiro.sysmenu.dao.SysMenuDao;
...
public class SysMenuService implements Serializable {
    ...
    public List<SysMenuDTO> searchSysMenu(SysMenuDTO dto) throws Exception {
    ...
    public List<SysMenuDTO> querySysMenuByUserId(String userId) throws Exception {
        return dao.querySysMenuByUserId(userId);
