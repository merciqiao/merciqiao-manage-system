...
// */
//@Component("com.car.modules.flow.carflow.creditaudit.eventlistener.CarCreditAuditUpdateBizTaskType")
//public class CarCreditAuditUpdateBizTaskType implements EventListener {
...
//        logger.info(MessageFormat.format("CarCreditAuditUpdateBizTaskType sucess,orderNum:{0}",orderNum));
//
//    }
//}
