...
@Component("com.carloan.quartz.job.DispatchAuditTaskJob")
public class DispatchAuditTaskJob extends AbstractTaskJob implements Job, Serializable {
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            jbpm4ServiceFeign.dispatchJob(CarFlowConst.CAR_TASKTYPE_XINSHEN, CarFlowConst.AUDIT);
        } finally {
            //清除redis缓存
            redisService.delete(KEY + ":" + RuleCodeConstant.AUDIT_RULE);
        }
    }
}