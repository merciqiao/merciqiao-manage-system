...
@Component("com.carloan.quartz.job.DispatchReconsiderationTaskJob")
public class DispatchReconsiderationTaskJob extends AbstractTaskJob implements Job, Serializable {
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            jbpm4ServiceFeign.dispatchJob(CarFlowConst.CAR_TASKTYPE_FUYI, CarFlowConst.RECONSIDERATION);
        } finally {
            //清除redis缓存
            redisService.delete(KEY + ":" + RuleCodeConstant.RECONSIDERATION_RULE);
        }
    }
}
